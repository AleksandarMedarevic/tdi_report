### Mapiranje za tabelu 11.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.3 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Previously treated - TOTAL (Males, Females and not known / missing) 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.3 --------
...
# Create sheet and file with Table_11.1.3  ----------------------------------

tabela_11.1.3 <- data.frame(
...
tabela_11.1.3[tabela_11.1.3 == "NaN"] <- NA
tabela_11.1.3[is.na(tabela_11.1.3)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
