### Mapiranje za tabelu 25.1.2 iz .sjz.rs baze: ----
### ---
###
### ---
### 25.1.2 Primary  Cocaine  (total) clients by other (secondary) drugs – 
### All treatment entrants (Never previously treated + Previously treated + Not known/Missing)
### ---

## Sracunaj vrednosti za  TDI tabelu 25.1.2 ----
...
# Create sheet and file with Table_25.1.2  ----------------------------------

tabela_25.1.2 <- data.frame(
...
write.xlsx(tabela_25.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_25.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
