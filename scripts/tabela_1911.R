### Mapiranje za tabelu 19.1.1 iz .sjz.rs baze: ----
### ---
...
### --
### Route of administration = Uobichajen_nachin_korishcenja_-_glavni_uzrok_zavisnosti
### inject = (1 - Injektiranjem)
### smoke/ \ninhale = (2 - Pušenjem/udisanjem)
### eat/ \ndrink = (3 - Jelom/pićem)
### sniff = (4 - Ušmrkavanjem)
### other = (5 - Drugo)
### Not known / missing   = ("0 - Nepoznat podatak")
### Total = Zbir svega 
### ---
### 19.1.1 Primary drug by route of administration –  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)
###
### Sracunaj vrednosti za  TDI tabelu 19.1.1 ----


# Za injektiranjem only ----------------------------------------------

baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti == "1 - Injektiranjem")
...
# Za pušenjem/udisanjem only -----------------------------------------------

baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti == "2 - Pušenjem/udisanjem")
...
baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti == "3 - Jelom/pićem")
...
baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti== "4 - Ušmrkavanjem")
...
baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti== "5 - Drugo")
...
baza_working <- baza |> 
  filter(Uobichajen_nachin_korishcenja_glavni_uzrok_zavisnosti == "0 - Nepoznat podatak")
...
tabela_19.1.1 <- data.frame(
  ...
  inject = c("1. inject", c1r1, c1r2, c1r3, c1r4, c1r5, c1r6, c1r7, c1r8, c1r9, c1r10, c1r11, c1r12, c1r13, c1r14, c1r15, c1r16, c1r17, c1r18, c1r19, c1r20, c1r21, c1r22, c1r23, c1r24, c1r25, c1r26, c1r27, c1r28, c1r29, c1r30, c1r31, c1r32, c1r33),
  smoke_inhale = c("2. smoke\n/inhale", c2r1, c2r2, c2r3, c2r4, c2r5, c2r6, c2r7, c2r8, c2r9, c2r10, c2r11, c2r12, c2r13, c2r14, c2r15, c2r16, c2r17, c2r18, c2r19, c2r20, c2r21, c2r22, c2r23, c2r24, c2r25, c2r26, c2r27, c2r28, c2r29, c2r30, c2r31, c2r32, c2r33),
  eat_drink = c("3. eat\n/drink", c3r1, c3r2, c3r3, c3r4, c3r5, c3r6, c3r7, c3r8, c3r9, c3r10, c3r11, c3r12, c3r13, c3r14, c3r15, c3r16, c3r17, c3r18, c3r19, c3r20, c3r21, c3r22, c3r23, c3r24, c3r25, c3r26, c3r27, c3r28, c3r29, c3r30, c3r31, c3r32, c3r33),
  sniff = c("4. sniff", c4r1, c4r2, c4r3, c4r4, c4r5, c4r6, c4r7, c4r8, c4r9, c4r10, c4r11, c4r12, c4r13, c4r14, c4r15, c4r16, c4r17, c4r18, c4r19, c4r20, c4r21, c4r22, c4r23, c4r24, c4r25, c4r26, c4r27, c4r28, c4r29, c4r30, c4r31, c4r32, c4r33),
  other = c("5. other", c5r1, c5r2, c5r3, c5r4, c5r5, c5r6, c5r7, c5r8, c5r9, c5r10, c5r11, c5r12, c5r13, c5r14, c5r15, c5r16, c5r17, c5r18, c5r19, c5r20, c5r21, c5r22, c5r23, c5r24, c5r25, c5r26, c5r27, c5r28, c5r29, c5r30, c5r31, c5r32, c5r33),
...
write.xlsx(tabela_19.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_19.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
