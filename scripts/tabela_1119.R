### Mapiranje za tabelu 11.1.9 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.9 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Previously treated - FEMALES 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.9 --------
...
# Create sheet and file with Table_11.1.9  ----------------------------------

tabela_11.1.9 <- data.frame(
...
tabela_11.1.9[tabela_11.1.9 == "NaN"] <- NA
tabela_11.1.9[is.na(tabela_11.1.9)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.9, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.9", append=TRUE, col.names=FALSE, row.names=FALSE)
