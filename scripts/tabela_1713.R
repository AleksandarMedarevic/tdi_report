### Mapiranje za tabelu 17.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 17.1.2 Primary drug by educational level –  Previously treated
## Sracunaj vrednosti za  TDI tabelu 17.1.3 --------
...
# Create sheet and file with Table_17.1.3  ----------------------------------

tabela_17.1.3 <- data.frame(
...
write.xlsx(tabela_17.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_17.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
