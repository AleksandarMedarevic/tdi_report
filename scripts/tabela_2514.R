### Mapiranje za tabelu 25.1.4 iz .sjz.rs baze: ----
### ---
###
### ---
...
## Sracunaj vrednosti za  TDI tabelu 25.1.4 ----
...
write.xlsx(tabela_25.1.4, file="data/izlazniPodaci.xlsx", sheetName="tabela_25.1.4", append=TRUE, col.names=FALSE, row.names=FALSE)
