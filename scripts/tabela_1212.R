### Mapiranje za tabelu 12.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 12.1.2 Primary drug by age –  Never previously treated
### ---
## Sracunaj vrednosti za  TDI tabelu 12.1.2 --------
...
baza_working <- baza|> 
  filter(year_complete_round_categories == "20-14") |> 
  filter(Da_li_se_lice_ranije_lechilo_od_bolesti_zavisnosti_povezane_sa_psihoaktivnim_supstancama == "5 - Ne, nije se nikad ranije lečilo")
...
baza_working <- baza|> 
  filter(year_complete_round_categories == "30-14") |> 
  filter(Da_li_se_lice_ranije_lechilo_od_bolesti_zavisnosti_povezane_sa_psihoaktivnim_supstancama == "5 - Ne, nije se nikad ranije lečilo")
...
# Za Total age of the first use only -----------------------------------------------------------------
...
# Create sheet and file with Table_12.1.2  ----------------------------------

tabela_12.1.2 <- data.frame(
...
tabela_12.1.2[tabela_12.1.2 == "NaN"] <- NA
tabela_12.1.2[is.na(tabela_12.1.2)] <- ""  

#View(tabela_12.1.2)

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_12.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_12.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
