### Mapiranje za tabelu 26.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 26.1.3 HIV testing by injecting behaviour –  Previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 26.1.3 ----
...
# Create sheet and file with Table_26.1.3  ----------------------------------

tabela_26.1.3 <- data.frame(
...
write.xlsx(tabela_26.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_26.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
