### Mapiranje za tabelu 16.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 16.1.3 Primary drug by living status (where) –  Previously treated
### ---
## Sracunaj vrednosti za  TDI tabelu 16.1.3 --------
...
# Create sheet and file with Table_16.1.3  ----------------------------------

tabela_16.1.3 <- data.frame(
...
write.xlsx(tabela_16.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_16.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)