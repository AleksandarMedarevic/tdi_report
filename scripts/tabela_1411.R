### Mapiranje za tabelu 14.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 14.1.1 Primary drug by living status (with whom) –  Total  (Male + Female + Not known/Missing)
###---
...
write.xlsx(tabela_14.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_14.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
