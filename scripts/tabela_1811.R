### Mapiranje za tabelu 18.1.1 iz .sjz.rs baze: ----
### ---
...
### --
### Labour status = Radni_status
### 1. occasionally \nemployed = "2 - Obavlja privremene i povremene poslove"
### 2. regularly \nemployed = "1 - Zaposlen"
### 3. student  = "4 - Učenik/student"
### 4. unemployed \ndiscouraged = = "3 - Nezaposlen"
### 5. recieving social \nbenefits /\npensioners / = "5 - Domaćin/domaćica"
### 5. recieving social \nbenefits /\npensioners / = "6 - Penzioner"
### 5. recieving social \nbenefits /\npensioners / = "7 - Korisnik socijalne pomoći"
### 5. recieving social \nbenefits /\npensioners / = "8 - Nije sposoban za rad"
### 6. other = "9 - Drugo"
### 99. not know n/ missing = "0 - Nepoznat podatak"
### Total = Zbir svega 
### ---
### 18.1.1 Primary drug by labour status –  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)

## Sracunaj vrednosti za  TDI tabelu 18.1.1 --------

# Za occasionaly employed only ----------------------------------------------

baza_working <- baza |> 
  filter(Radni_status == "2 - Obavlja privremene i povremene poslove")
...
# Za regularly employed only ---------------------------------------------------------

baza_working <- baza |> 
  filter(Radni_status == "1 - Zaposlen")
...
baza_working <- baza |> 
  filter(Radni_status == "4 - Učenik/student")
...
baza_working <- baza |> 
  filter(Radni_status == "3 - Nezaposlen")
...
# Za receiving social benefits, pensioners, house-makers, disabled only -----------------------------------------------------

baza_working <- baza |> 
  filter(Radni_status == "5 - Domaćin/domaćica" |
           Radni_status == "4 - Penzioner" |
           Radni_status == "7 - Korisnik socijalne pomoći" |
           Radni_status == "8 - Nije sposoban za rad" )
...
baza_working <- baza |> 
  filter(Radni_status == "0 - Nepoznat podatak")
...
# Create sheet and file with Table_18.1.1  ----------------------------------

tabela_18.1.1 <- data.frame(
  ...
  occasionally = c("1. occasionally \nemployed", c1r1, c1r2, c1r3, c1r4, c1r5, c1r6, c1r7, c1r8, c1r9, c1r10),
  regularly_employed = c("2. regularly \nemployed", c2r1, c2r2, c2r3, c2r4, c2r5, c2r6, c2r7, c2r8, c2r9, c2r10),
  student = c("3. student", c3r1, c3r2, c3r3, c3r4, c3r5, c3r6, c3r7, c3r8, c3r9, c3r10),
  unemployed = c("4. unemployed \n/discouraged", c4r1, c4r2, c4r3, c4r4, c4r5, c4r6, c4r7, c4r8, c4r9, c4r10),
  social_pensioners = c("5. receving social \nbenefits /pensioners\n house-makers", c5r1, c5r2, c5r3, c5r4, c5r5, c5r6, c5r7, c5r8, c5r9, c5r10),
  other = c("6. other", c6r1, c6r2, c6r3, c6r4, c6r5, c6r6, c6r7, c6r8, c6r9, c6r10),
  not_known = c("99. not know n/ missing", c7r1, c7r2, c7r3, c7r4, c7r5, c7r6, c7r7, c7r8, c7r9, c7r10),
  total = c("Total", c8r1, c8r2, c8r3, c8r4, c8r5, c8r6, c8r7, c8r8, c8r9, c8r10)
)
#print(tabela_18.1.1) 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_18.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_18.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
