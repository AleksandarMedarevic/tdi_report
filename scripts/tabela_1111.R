### Mapiranje za tabelu 11.1.1 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.1 Primary drug by mean age at entering current treatment, at age at first use,
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.1 --------
...
# Create sheet and file with Table_11.1.1  ----------------------------------

tabela_11.1.1 <- data.frame(
...
tabela_11.1.1[tabela_11.1.1 == "NaN"] <- NA
tabela_11.1.1[is.na(tabela_11.1.1)] <- ""  
...
write.xlsx(tabela_11.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
