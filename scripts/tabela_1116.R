### Mapiranje za tabelu 11.1.6 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.6 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Previously treated - MALES 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.6 --------
...
# Create sheet and file with Table_11.1.6  ----------------------------------

tabela_11.1.6 <- data.frame(
...
tabela_11.1.6[tabela_11.1.6 == "NaN"] <- NA
tabela_11.1.6[is.na(tabela_11.1.6)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.6, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.6", append=TRUE, col.names=FALSE, row.names=FALSE)
