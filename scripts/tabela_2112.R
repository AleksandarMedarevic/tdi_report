### Mapiranje za tabelu 21.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 21.1.2 Primary drug by age at first use –  Never previously treated 
### ---
...
# Create sheet and file with Table_21.1.2  ----------------------------------

tabela_21.1.2 <- data.frame(
...
write.xlsx(tabela_21.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_21.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
