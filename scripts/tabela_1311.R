### Mapiranje za tabelu 13.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### Primary drug by source of referral–  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)
###---
...
# Create sheet and file with Table_13.1.1  ----------------------------------

tabela_13.1.1 <- data.frame(
...
write.xlsx(tabela_13.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_13.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
