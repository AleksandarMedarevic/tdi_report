### Mapiranje za tabelu 22.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 22.1.2 Drug by injecting behaviour (any drug, no matter if primary or secondary) –  Never previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 22.1.2 ----
...
write.xlsx(tabela_22.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_22.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
