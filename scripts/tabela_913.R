### Mapiranje za tabelu 9.1.3 iz .sjz.rs baze: ----
### ---
...
## Sracunaj vrednosti za  TDI tabelu 9.1.3 ----
...
write.xlsx(tabela_9.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_9.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
