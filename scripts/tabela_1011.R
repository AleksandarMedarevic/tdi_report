### Mapiranje za tabelu 10.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### Primary drug by sex –  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)
###---

## Sracunaj vrednosti za  TDI tabelu 10.1.1 --------
...
# Create sheet and file with Table_10.1.1  ----------------------------------

tabela_10.1.1 <- data.frame(
...
write.xlsx(tabela_10.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_10.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
