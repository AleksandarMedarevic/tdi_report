### Mapiranje za tabelu 26.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 26.1.2 HIV testing by injecting behaviour –  Never previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 26.1.2 ----
...
# Create sheet and file with Table_26.1.2  ----------------------------------

tabela_26.1.2 <- data.frame(
...
write.xlsx(tabela_26.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_26.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
