### Mapiranje za tabelu 23.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 23.1.1 Age at entering current treatment by years since first injection.  Ever injectors - All treatment entrants  (Never previously treated + Previously treated + Not known / missing)
## Sracunaj vrednosti za  TDI tabelu 23.1.1 --------
...
# Create sheet and file with Table_23.1.1  ----------------------------------

tabela_23.1.1 <- data.frame(
...
write.xlsx(tabela_23.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_23.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
