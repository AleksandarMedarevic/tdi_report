### Mapiranje za tabelu 11.1.5 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.5 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Never previously treated - MALES 
### ---
...
# Create sheet and file with Table_11.1.5  ----------------------------------

tabela_11.1.5 <- data.frame(
...
tabela_11.1.5[tabela_11.1.5 == "NaN"] <- NA
tabela_11.1.5[is.na(tabela_11.1.5)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.5, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.5", append=TRUE, col.names=FALSE, row.names=FALSE)
