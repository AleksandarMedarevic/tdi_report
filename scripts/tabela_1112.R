### Mapiranje za tabelu 11.1.2 iz .sjz.rs baze: ----
### ---
...
###---
### 11.1.2 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Never previously treated - TOTAL (Males, Females and not known / missing) 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.2 --------
...
# Create sheet and file with Table_11.1.2  ----------------------------------

tabela_11.1.2 <- data.frame(
...
tabela_11.1.2[tabela_11.1.2 == "NaN"] <- NA
tabela_11.1.2[is.na(tabela_11.1.2)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
