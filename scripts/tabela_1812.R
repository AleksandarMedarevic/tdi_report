### Mapiranje za tabelu 18.1.2 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 18.1.2 Primary drug by labour status –  Never previously treated 

## Sracunaj vrednosti za  TDI tabelu 18.1.2 --------
...
# Create sheet and file with Table_18.1.2  ----------------------------------

tabela_18.1.2 <- data.frame(
...
write.xlsx(tabela_18.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_18.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
