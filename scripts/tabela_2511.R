### Mapiranje za tabelu 25.1.1 iz .sjz.rs baze: ----
### ---
### Primary drug  = Glavni_uzrok_zavisnosti
###
### ---
### 25.1.1 Primary  Opiates  (total) clients by other (secondary) drugs – 
### All treatment entrants (Never previously treated + Previously treated + Not known/Missing)
###

## Sracunaj vrednosti za  TDI tabelu 25.1.1 ----
...
# Za metamfetamin and amfetamin only ----------------------------------------------
...
# Create sheet and file with Table_25.1.1  ----------------------------------

tabela_25.1.1 <- data.frame(
...
write.xlsx(tabela_25.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_25.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
