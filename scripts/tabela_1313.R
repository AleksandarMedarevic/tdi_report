### Mapiranje za tabelu 13.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### Primary drug by source of referral– Previously treated 
###---
...
# Create sheet and file with Table_13.1.3  ----------------------------------

tabela_13.1.3 <- data.frame(
...
write.xlsx(tabela_13.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_13.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
