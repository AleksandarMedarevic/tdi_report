### Mapiranje za tabelu 22.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 22.1.3 Drug by injecting behaviour (any drug, no matter if primary or secondary) –  Previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 22.1.3 ----
...
# Create sheet and file with Table_22.1.3  ----------------------------------

tabela_22.1.3 <- data.frame(
...
write.xlsx(tabela_22.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_22.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
