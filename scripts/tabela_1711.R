### Mapiranje za tabelu 17.1.1 iz .sjz.rs baze: ----
### ---
...
### --
### Educational level = Najvisha_zavrshena_shkola
### 1. never went \nto school/ \nnever completed = "Bez škole"
### 1. never went \nto school/ \nnever completed = "Nepotpuna osnovna škola"
### 2. primary \nlevel of \neducation  = "Osnovna škola (8 razreda)"
### 3. secondary \nlevel of \neducation = "Srednja škola"
### 4. higher \nlevel of \neducation = "Viša škola"
### 4. higher \nlevel of \neducation = "Visoka škola/fakultet/akademija"
### 99. not know n/ missing = "Nepoznato"
### Total = Zbir svega 
### ---
### 17.1.1 Primary drug by educational level –  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)

## Sracunaj vrednosti za  TDI tabelu 17.1.1 --------

# Za without school only ----------------------------------------------

baza_working <- baza |> 
  filter(Najvisha_zavrshena_shkola == "Bez škole" |
           Najvisha_zavrshena_shkola == "Nepotpuna osnovna škola")
...
# Za primary school only ---------------------------------------------------------

baza_working <- baza |> 
  filter(Najvisha_zavrshena_shkola == "Osnovna škola (8 razreda)")
...
# Za secondary school only -----------------------------------------------------

baza_working <- baza |> 
  filter(Najvisha_zavrshena_shkola == "Srednja škola")
...
# Za higher educational only -----------------------------------------------------

baza_working <- baza |> 
  filter(Najvisha_zavrshena_shkola == "Viša škola" |
           Najvisha_zavrshena_shkola == "Visoka škola/fakultet/akademija")
...
baza_working <- baza |> 
  filter(Najvisha_zavrshena_shkola == "Nepoznato")
...
# Create sheet and file with Table_17.1.1  ----------------------------------

tabela_17.1.1 <- data.frame(
  ...
  no_school = c("1. never went \nto school \nnever complete ", c1r1, c1r2, c1r3, c1r4, c1r5, c1r6, c1r7, c1r8, c1r9, c1r10),
  elementary_school = c("2. primary \nlevel of \neducation", c2r1, c2r2, c2r3, c2r4, c2r5, c2r6, c2r7, c2r8, c2r9, c2r10),
  secondary_school = c("3. secondary \nlevel of \neducation", c3r1, c3r2, c3r3, c3r4, c3r5, c3r6, c3r7, c3r8, c3r9, c3r10),
  higher_school = c("4. higher \nlevel of \neducation", c4r1, c4r2, c4r3, c4r4, c4r5, c4r6, c4r7, c4r8, c4r9, c4r10),
...
write.xlsx(tabela_17.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_17.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
