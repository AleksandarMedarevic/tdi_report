### Mapiranje za tabelu 20.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 20.1.2 Primary drug by frequency of use –  Never previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 20.1.2 ----
...
write.xlsx(tabela_20.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_20.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
