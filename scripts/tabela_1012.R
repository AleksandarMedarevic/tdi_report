### Mapiranje za tabelu 10.1.2 iz .sjz.rs baze: ----
### ---
...
## Sracunaj vrednosti za  TDI tabelu 10.1.2 --------
...
c1r33 <- c1r1 + c1r7 + c1r11 + c1r17 + c1r22 + c2r26 + c1r27 + c1r31 + c1r32
...
# Create sheet and file with Table_10.1.2  ----------------------------------

tabela_10.1.2 <- data.frame(
...
write.xlsx(tabela_10.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_10.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
