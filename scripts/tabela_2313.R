### Mapiranje za tabelu 23.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 23.1.2 Age at entering current treatment by years since first injection.  Ever injectors - Previously treated 
...
write.xlsx(tabela_23.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_23.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
