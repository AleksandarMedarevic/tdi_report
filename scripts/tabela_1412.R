### Mapiranje za tabelu 14.1.2 iz .sjz.rs baze: ----
### ---
...
### Male = "Muško"
### ---
### 14.1.1 Primary drug by living status (with whom) –  Male
###---

## Sracunaj vrednosti za  TDI tabelu 14.1.2 --------
...
# Create sheet and file with Table_14.1.1  ----------------------------------

tabela_14.1.2 <- data.frame(
...
write.xlsx(tabela_14.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_14.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
