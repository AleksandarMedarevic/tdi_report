### Mapiranje za tabelu 25.1.5 iz .sjz.rs baze: ----
### ---
###
### ---
### 25.1.4 Primary  Cannabis  (total) clients by other (secondary) drugs – 
### All treatment entrants (Never previously treated + Previously treated + Not known/Missing)
### ---

## Sracunaj vrednosti za  TDI tabelu 25.1.5 ----
...
# Create sheet and file with Table_25.1.5  ----------------------------------

tabela_25.1.5 <- data.frame(
...
write.xlsx(tabela_25.1.5, file="data/izlazniPodaci.xlsx", sheetName="tabela_25.1.5", append=TRUE, col.names=FALSE, row.names=FALSE)
