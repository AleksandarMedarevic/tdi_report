### Mapiranje za tabelu 16.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 16.1.2 Primary drug by living status (where) –  Never previously treated

## Sracunaj vrednosti za  TDI tabelu 16.1.2 --------
...
# Create sheet and file with Table_16.1.2  ----------------------------------

tabela_16.1.2 <- data.frame(
...
write.xlsx(tabela_16.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_16.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)