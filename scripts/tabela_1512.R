### Mapiranje za tabelu 15.1.2 iz .sjz.rs baze: ----
### ---
...
### Pol = "Muško"
### ---
### 15.1.2 Primary drug by living status (with children) -  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing) –  Male
### ---

## Sracunaj vrednosti za  TDI tabelu 15.1.2 --------
...
write.xlsx(tabela_15.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_15.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
