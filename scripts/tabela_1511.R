### Mapiranje za tabelu 15.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 15.1.1 Primary drug by living status (with children) -  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing) –  Total  (Male + Female + Not known/Missing)
### ---

## Sracunaj vrednosti za  TDI tabelu 15.1.1 --------
...
# Create sheet and file with Table_15.1.1  ----------------------------------

tabela_15.1.1 <- data.frame(
...
write.xlsx(tabela_15.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_15.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
