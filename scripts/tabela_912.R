### Mapiranje za tabelu 9.1.2 iz .sjz.rs baze: ----
### ---
...
## Sracunaj vrednosti za  TDI tabelu 9.1.2 ----
...
# Create sheet and file with Table_9.1.2  ----------------------------------

tabela_9.1.2 <- data.frame(
...
write.xlsx(tabela_9.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_9.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
