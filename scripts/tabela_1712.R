### Mapiranje za tabelu 17.1.2 iz .sjz.rs baze: ----
### ---
...
### ---
### 17.1.2 Primary drug by educational level –  Never previously treated
## Sracunaj vrednosti za  TDI tabelu 17.1.2 --------
...
write.xlsx(tabela_17.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_17.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
