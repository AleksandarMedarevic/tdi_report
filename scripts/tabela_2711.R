### Mapiranje za tabelu 27.1.1 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 27.1.1 HCV testing by injecting behaviour -  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing)
### ---
### Sracunaj vrednosti za  TDI tabelu 27.1.1 ----
...
# Create sheet and file with Table_27.1.1  ----------------------------------

tabela_27.1.1 <- data.frame(
...
write.xlsx(tabela_27.1.1, file="data/izlazniPodaci.xlsx", sheetName="tabela_27.1.1", append=TRUE, col.names=FALSE, row.names=FALSE)
