### Mapiranje za tabelu 21.1.3 iz .sjz.rs baze: ----
### ---
...
###---
### 21.1.3 Primary drug by age at first use –  Previously treated 
### ---
...
write.xlsx(tabela_21.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_21.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
