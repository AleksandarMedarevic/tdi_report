### Mapiranje za tabelu 19.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 19.1.2 Primary drug by route of administration –  Never previously treated
###
### Sracunaj vrednosti za  TDI tabelu 19.1.2 ----
...
write.xlsx(tabela_19.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_19.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
