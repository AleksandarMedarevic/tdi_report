...
## Kreiraj TDI tabelu 8.1.3
tabela_8.1.3 <- data.frame(
...
write.xlsx(tabela_8.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_8.1.3", col.names=FALSE, row.names=FALSE, append = T)
