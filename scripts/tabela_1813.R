### Mapiranje za tabelu 18.1.3 iz .sjz.rs baze: ----
### ---
...
### Total = Zbir svega 
### ---
### 18.1.3 Primary drug by labour status –  Previously treated 

## Sracunaj vrednosti za  TDI tabelu 18.1.3 --------
...
write.xlsx(tabela_18.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_18.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
