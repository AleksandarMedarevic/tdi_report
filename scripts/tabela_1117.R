### Mapiranje za tabelu 11.1.7 iz .sjz.rs baze: ----
### ---
...
### Pol = Žensko
### ---
### 11.1.7 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -  All treatment entrants  (Never previously treated + Previously treated + Not known/Missing) -  FEMALES 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.7 --------
...
# Create sheet and file with Table_11.1.7  ----------------------------------

tabela_11.1.7 <- data.frame(
...
tabela_11.1.7[tabela_11.1.7 == "NaN"] <- NA
tabela_11.1.7[is.na(tabela_11.1.7)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.7, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.7", append=TRUE, col.names=FALSE, row.names=FALSE)
