### Mapiranje za tabelu 27.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 27.1.3 HCV testing by Injecting behaviour  –  Previously treated 
### ---
### Sracunaj vrednosti za  TDI tabelu 27.1.3 ----
...
# Create sheet and file with Table_27.1.3  ----------------------------------

tabela_27.1.3 <- data.frame(
...
write.xlsx(tabela_27.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_27.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
