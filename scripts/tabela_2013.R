### Mapiranje za tabelu 20.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 20.1.3 Primary drug by frequency of use –  Previously treated 
### ---
...
# Create sheet and file with Table_20.1.3  ----------------------------------

tabela_20.1.3 <- data.frame(
...
write.xlsx(tabela_20.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_20.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
