### Mapiranje za tabelu 12.1.3 iz .sjz.rs baze: ----
### ---
...
### ---
### 12.1.3 Primary drug by age –  Previously treated
### ---
## Sracunaj vrednosti za  TDI tabelu 12.1.3 --------
...
# Create sheet and file with Table_12.1.3  ----------------------------------

tabela_12.1.3 <- data.frame(
...
tabela_12.1.3[tabela_12.1.3 == "NaN"] <- NA
tabela_12.1.3[is.na(tabela_12.1.3)] <- ""  

#View(tabela_12.1.3)

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_12.1.3, file="data/izlazniPodaci.xlsx", sheetName="tabela_12.1.3", append=TRUE, col.names=FALSE, row.names=FALSE)
