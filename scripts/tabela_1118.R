### Mapiranje za tabelu 11.1.8 iz .sjz.rs baze: ----
### ---
...
### ---
### 11.1.8 Primary drug by mean age at entering current treatment, at age at first use, and mean lag to current treatment -   Never previously treated - FEMALES 
### ---
## Sracunaj vrednosti za  TDI tabelu 11.1.5 --------
...
# Create sheet and file with Table_11.1.8  ----------------------------------

tabela_11.1.8 <- data.frame(
...
tabela_11.1.8[tabela_11.1.8 == "NaN"] <- NA
tabela_11.1.8[is.na(tabela_11.1.8)] <- "" 

# Sacuvaj izlazni fajl ----------------------------------------------------
write.xlsx(tabela_11.1.8, file="data/izlazniPodaci.xlsx", sheetName="tabela_11.1.8", append=TRUE, col.names=FALSE, row.names=FALSE)
