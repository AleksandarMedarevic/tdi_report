### Mapiranje za tabelu 19.1.2 iz .sjz.rs baze: ----
### ---
...
write.xlsx(tabela_19.1.2, file="data/izlazniPodaci.xlsx", sheetName="tabela_19.1.2", append=TRUE, col.names=FALSE, row.names=FALSE)
